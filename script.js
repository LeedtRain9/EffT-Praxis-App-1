const questions = {
    ...
    Elektroinstallation: [
        ...
        { 
            type: "textWithImage", 
            question: "Links zu sehen das Schema der AP 1. Rechts eine entsprechende Umsetzung eines Teilnehmenden ohne vorherige Kenntnisse. Was denken Sie dazu?", 
            image: "Bilder Elektroinstallation/bild31.jpg", 
            answers: ["Es fehlen Kabelschellen", "Die Leitungsführung ist krum und schief", "Ne glatte 1", "Der Platz auf dem Panel hätte mehr ausgenutzt werden"], 
            correct: [0, 1, 3] 
        },
        ...
        { 
            type: "textWithImage", 
            question: "Links zu sehen das Schema der AP 1. Rechts eine entsprechende Umsetzung eines Teilnehmenden ohne vorherige Kenntnisse. Was denken Sie dazu?", 
            image: "Bilder Elektroinstallation/bild32.jpg", 
            answers: ["Ne glatte 6", "Die Leitungsführung ist mangelhaft", "Ne glatte 1. Orientieren Sie sich daran!", "Der Platz auf dem Panel hätte mehr ausgenutzt werden"], 
            correct: [2] 
        },
        ...
        { 
            ...
            image: "Bilder Elektroinstallation/bild2_3.jpg", 
            answers: ["Bild links", "Bild rechts"], 
            correct: [1] 
        },

        { 
            type: "textWithImage", 
            question: 'Wie beurteilen Sie diese Abzweigdose?', 
            image: "Bilder Elektroinstallation/bild33.jpg",
            answers: ["Chaos", "Adern sind zu lang. Das geht besser", "Blinde Adern ohne Klemme, es sei denn die Gefahr besteht, dass diese Spannung führen können"], 
            correct: [0, 1, 2] 
        },

        { 
            type: "textWithImage", 
            question: 'Welchen gravierenden Fehler finden Sie bei dieser Verdrahtung?', 
            image: "Bilder Elektroinstallation/bild34.jpg",
            answers: ["Braun und schwarz müssen vertauscht werden", "Die graue Ader ist beschädigt", "Alles jott"], 
            correct: [1] 
        },

        {
            ...
            image: "Bilder Elektroinstallation/bild4.jpg", 
        ...
        { 
            type: "textWithImage", 
            question: 'Was hätte man bei der Schukosteckdose besser machen sollen?', 
            image: "Bilder Elektroinstallation/bild35.jpg",
            answers: ["Die Adern hätten bis unten abgemnantelt und von unten angeschlossen werden", "Die Adern sind zu kurz", "Ein Wunder der Natur"], 
            correct: [0, 1] 
        },

        { 
            type: "textWithImage", 
            question: 'Wie beurteilen Sie das Ergebnis?', 
            image: "Bilder Elektroinstallation/bild36.jpg",
            answers: ["Sehr gut. So muss es sein", "Schlimm wer sowas anbietet"], 
            correct: [0] 
        },

        { 
            type: "textWithImage", 
            question: 'Was hätte man hier beim Leuchtenanschluss besser machen können?', 
            image: "Bilder Elektroinstallation/bild37.jpg",
            answers: ["Nichts weiter", "Adern weniger abisoliert", "Mehr Reserve bei der Aderlänge, falls später ein anderen Leuchtentyp installiert werden sollte"], 
            correct: [1, 2] 
        },

        { 
            type: "textWithImage", 
            question: 'Was könnte man hier verbessern?', 
            image: "Bilder Elektroinstallation/bild38.jpg",
            answers: ["Nichts. Sieht aus wie bestellt", "Die blaue Ader wie die braune verlegen", "Den PE gerade verlegen und hinter die Blende"], 
            correct: [1, 2] 
        },

        { 
            type: "textWithImage", 
            question: 'Welcher signifikante Fehler ist dem Teilnehmenden hier unterlaufen?', 
            image: "Bilder Elektroinstallation/bild39.jpg",
            answers: ["PE gekürztz. Das geht gar nicht", "Adern insgesamt zu lang gelassen"], 
            correct: [0] 
        },
